...
public class InstantNoodlesTimer extends AppCompatActivity {

    //可自定義時間
    private static final long START_TIME_MILLIS = 180000;    //總時間秒數(millis)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_instant_noodles_timer);
        init();
