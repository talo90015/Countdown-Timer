...
public class DrinkTimer extends AppCompatActivity {
    ...
    private Button btnCoffeeTime;
    private Button btnTeaBagTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCoffeeTime = findViewById(R.id.btnCoffeeTime);   //泡咖啡時間
        btnTeaBagTime = findViewById(R.id.btnTeaBagTime);   //泡茶包時間
        ...
        btnCoffeeTime.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                timeLeftInMillis = 120000;
                showCountDownTime.setText("02:00");
                btn_Start_and_Pause.setVisibility(View.VISIBLE);
            }
        });

        btnTeaBagTime.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                timeLeftInMillis = 300000;
                showCountDownTime.setText("05:00");
                btn_Start_and_Pause.setVisibility(View.VISIBLE);
            }
        });
    }
